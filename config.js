...
module.exports = {
  ...
  basicAuth: {
    username: process.env.ME_CONFIG_BASICAUTH_USERNAME || secret.dbConfig.auth.username,
    password: process.env.ME_CONFIG_BASICAUTH_PASSWORD || secret.dbConfig.auth.password,
  },
